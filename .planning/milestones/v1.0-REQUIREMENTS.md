...
### Content Quality & Ingestability (from curriculum review)

- **CQ-01**: WhyThisMatters callout component — 1-2 sentence boxes connecting concepts to real decisions
- **CQ-02**: Visual density target — 1 diagram/visual per 2-3 concept blocks in generated content
- **CQ-03**: Cross-pillar connections populated during AI content generation (lesson_connections table)
- **CQ-04**: Writing-focused exercises included across all pillars (at least 1 per course)

### Curriculum Structure (decisions needed before content generation)

- **CURR-01**: Resolve AI Pillar sequencing — math-first vs engagement-first entry point
- **CURR-02**: Resolve Robotics scope — standalone pillar or merge into Technical Systems
- **CURR-03**: Resolve Personal Finance — add to Business Competence or standalone mini-pillar
- **CURR-04**: Add intellectual-history connection type to lesson_connections

> See `curriculum-research/07-curriculum-review-refinements.md` for full analysis and priority matrix.

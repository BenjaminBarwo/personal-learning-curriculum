...
- [ ] **Phase 8: Clerk Auth Wiring** — Real auth enforcement: sign-in page, middleware protection, remove hardcoded user
- [ ] **Phase 9: FSRS Data Layer** — FSRS tables in Supabase, auto-seed cards from lesson completion, server actions

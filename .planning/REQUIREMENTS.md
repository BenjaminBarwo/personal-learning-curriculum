...
- [ ] **FSRS-01**: `review_cards` table exists in Supabase with FSRS card state fields (due, stability, difficulty, state, reps, lapses)
- [ ] **FSRS-02**: Review cards are auto-seeded from quiz questions when a lesson is completed
